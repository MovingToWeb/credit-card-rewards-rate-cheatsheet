# 💳 Credit Card Rewards Rate Cheatsheet - My Info
...
```mermaid
pie title Best Card by Use Cases
    "DCB (Diners Black)" : 11
    "AU Zenith" : 11
    "Emerald Private" : 8
    "HSBC Live+" : 4
...
```mermaid
xychart-beta
    title "Best Reward Rates by Spend Category (%)"
    x-axis ["Hotels*", "SB Hotels", "Airtel", "Flights*", "SB Flights", "Grocery", "Dining", "Swiggy", "Wknd Dine", "Fastag", "Amazon", "Fuel", "Apparel", "Education", "Default"]
    y-axis "Effective Reward %" 0 --> 40
    bar [36, 33, 25, 18, 15, 10, 10, 10, 7, 6, 5, 4, 3, 3, 3]
```
...
```mermaid
flowchart TD
    START(["What are you spending on?"])

    START --> SHOP["Shopping"]
    START --> FOOD["Food & Dining"]
    START --> TRAVEL["Travel"]
    START --> BILLS["Bills & Utilities"]
    START --> OTHER["Other"]

    SHOP --> S1["Amazon<br/><b>ICICI Amazon 5%</b>"]
    SHOP --> S2["Flipkart<br/><b>SmartBuy DCB 6.66%</b>"]
    SHOP --> S3["Groceries<br/><b>HSBC Live+ 10%</b>"]
    SHOP --> S4["Apparel<br/><b>Axis Rewards 3.2%</b>"]
    SHOP --> S5["Gold/Jewellery<br/><b>Emerald Private 3%</b>"]

    FOOD --> F1["Swiggy / Zomato<br/><b>Airtel Axis 10%</b>"]
    FOOD --> F2["Weekend Dining<br/><b>DCB 6.66%</b>"]
    FOOD --> F3["Restaurants / Veg<br/><b>HSBC Live+ 10%</b>"]
    FOOD --> F4["Weekday Dining<br/><b>AU Zenith 4%</b>"]

    TRAVEL --> T1["Flights<br/><b>SmartBuy DCB 15%</b>"]
    TRAVEL --> T2["Hotels<br/><b>SmartBuy DCB 33%</b>"]
    TRAVEL --> T3["Bus / Train<br/><b>SmartBuy DCB 10%</b>"]
    TRAVEL --> T4["International<br/><b>Citi Debit 0% markup</b>"]

    BILLS --> B1["Airtel Recharge<br/><b>Airtel Axis 25%</b>"]
    BILLS --> B2["TNEB / Gas<br/><b>Airtel Axis 10%</b>"]
    BILLS --> B3["Insurance<br/><b>HSBC Premier 3%</b>"]
    BILLS --> B4["JioFiber<br/><b>Amazon Pay DCB 3x</b>"]

    OTHER --> O1["Fuel<br/><b>IOCL Axis UPI 4%</b>"]
    OTHER --> O2["Fastag<br/><b>AU Zenith+CRED 6%</b>"]
    OTHER --> O3["Education<br/><b>DCB 3.33%</b>"]
    OTHER --> O4["Movies<br/><b>AU Zenith BOGO</b>"]
    OTHER --> O5["Govt Txns<br/><b>IDFC Wealth 0.5%</b>"]
    OTHER --> O6["Everything Else<br/><b>HSBC Live+ 1.5%</b>"]

    style START fill:#0078D4,color:#fff,stroke:none
    style SHOP fill:#50E6FF,color:#000,stroke:none
    style FOOD fill:#50E6FF,color:#000,stroke:none
    style TRAVEL fill:#50E6FF,color:#000,stroke:none
    style BILLS fill:#50E6FF,color:#000,stroke:none
    style OTHER fill:#50E6FF,color:#000,stroke:none
```
...
```mermaid
xychart-beta
    title "Monthly Spend Milestones (in thousands)"
    x-axis ["DCB", "IDFC Wealth", "Axis Rewards", "Emerald Private"]
    y-axis "Monthly Spend Target (K)" 0 --> 100
    bar [80, 50, 30, 33]
```
